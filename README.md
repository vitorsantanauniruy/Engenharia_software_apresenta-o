...
> **Nota para a equipe:** Salve as imagens geradas no Draw.io em uma pasta chamada `docs` dentro do projeto e descomente as linhas abaixo para que as imagens apareçam no GitHub.
